import unittest
from CVAugmentor.assets.augmentations._exposure import Exposure
from PIL import Image, ImageChops


class TestExposure(unittest.TestCase):

    def test_exposure__factor_wrong__value_value__error(self):
        ...
        with self.assertRaises(ValueError):
            Exposure(exposure_factor=exposure_factor)
