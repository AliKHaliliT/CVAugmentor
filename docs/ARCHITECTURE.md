...
│       │   ├── config/         # PipelineConfig (frozen Pydantic model; no env at import)
...
│       │   ├── augmentations/  # The catalog; one module per augmentation
│       │   ├── media/          # Codecs: Pillow for stills, OpenCV for moving pictures
│       │   ├── progress/       # Progress sinks (tqdm)
